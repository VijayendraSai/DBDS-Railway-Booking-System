...
function LoginCustomer() {
  ...
  // Function to log the user in and store user data in sessionStorage
  const loginUser = async (username, password) => {
    try {
      ...
      if (response.status === 200) {
        const customerData = response.data; // Get customer data from the response
        ...
        alert("Login successful! Welcome, " + customerData.firstName);
